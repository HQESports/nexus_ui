            ...
            <div className="grid lg:grid-cols-12 gap-6 mb-6">
                ...
                <div className="col-span-12 lg:col-span-6">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 h-full">
                        <PercentStatCard title="Erangel" subtitle="Baltic_Main" value={metrics.map_distribution.Baltic_Main} total={metrics.total_matches} color="green" />
                        <PercentStatCard title="Miramar" subtitle="Desert_Main" value={metrics.map_distribution.Desert_Main} total={metrics.total_matches} color="orange" />
                        <PercentStatCard title="Rondo" subtitle="Neon_Main" value={metrics.map_distribution.Neon_Main} total={metrics.total_matches} color="purple" />
                        <PercentStatCard title="Taego" subtitle="Tiger_Main" value={metrics.map_distribution.Tiger_Main} total={metrics.total_matches} color="lime" />
                        <PercentStatCard title="Vikendi" subtitle="DihorOtok_Main" value={metrics.map_distribution.DihorOtok_Main} total={metrics.total_matches} color="blue" />
                        <PercentStatCard title="Deston" subtitle="Kiki_Main" value={metrics.map_distribution.Kiki_Main} total={metrics.total_matches} color="red" />
                    </div>
                </div>
            </div>
        </div>
